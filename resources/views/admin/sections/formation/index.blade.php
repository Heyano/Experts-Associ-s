                    ...
                    <div class="card-body">
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="card-header">
                                    <a href="{{ route('editFormation') }}" class="btn btn-primary" style="margin-left: 90%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex;">
                                                    ...
                                                    <div style="display: inline-block; flex: 1; margin: 5px;">
                                                        <a href="{{route('deleteFormation',$item->id)}}" class="btn btn-outline-danger" style="font-size: 7px !important;">
