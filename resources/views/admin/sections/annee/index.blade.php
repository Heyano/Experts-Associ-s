        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Année de la formations</h4>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Liste des années</h4>
                    </div><!-- end card header -->
                                            ...
                                            <td>
                                                <div style="display: flex;">
                                                    <div style="display: inline-block; flex: 1; margin: 5px;">
                                                        <a href="{{ route('deleteAnnee', $item->id) }}" class="btn btn-outline-danger" style="font-size: 7px !important;">
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                     <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Creation de l'année</h4>
                        <p class="text-muted mx-4 mb-0">Creation d'une nouvelle année de formation</p>
                    </div>
                </div>

                <div class="mt-4">
                    <form class="form" method="post" action="{{ route('AdminPostAnnee') }}">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-label">Libelle de l'année</label>
                                    <input type="date" class="form-control" name="label" placeholder="libelle de la année" required>
                                </div>
                            </div>
                        </div>
