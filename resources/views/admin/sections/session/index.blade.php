        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Session de la formations</h4>
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tr>
                                        <th>@lang('Nbr')</th>
                                        <th>@lang('Session')</th>
                                        <th>@lang('Date du début')</th>
                                        <th>@lang('Date de la fin')</th>
                                        <th>@lang('Status')</th>
                                        <th>@lang('Actions')</th>
                                    </tr>
                                    </thead>
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                     <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Creation de la sesion</h4>
                        <p class="text-muted mx-4 mb-0">Creation d'une nouvelle session de formation</p>
                    </div>
                </div>

                <div class="mt-4">
                    <form class="form" method="post" action="{{ route('AdminPostSession') }}">
                        @csrf
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label class="form-label">Libelle de la sesion</label>
                                    <input type="text" class="form-control" name="label" placeholder="libelle de la session" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-label">Libelle de la sesion</label>
                                    <input type="date" class="form-control" name="dateDebut" placeholder="date du début" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="form-label">Libelle de la sesion</label>
                                    <input type="date" class="form-control" name="dateFin" placeholder="date de la fin" required>
                                </div>
                            </div>
                        </div>
